...
bool GetAVXCapability() asm ("GetAVXCapability");
bool GetSSECapability() asm ("GetSSECapability");
...
void ADD_REG_1(int threadID) asm ("ADD_REG_1");
void AND_REG_REG(int threadID) asm ("AND_REG_REG");
void SHR_REG_CL(int threadID) asm ("SHR_REG_CL");
void PADDB_MMX(int threadID) asm ("PADDB_MMX");
void CMOVcc_REG_REG(int threadID) asm ("CMOVcc_REG_REG");
void FLOPS_SSE(int threadID) asm ("FLOPS_SSE");
void FLOPS_AVX(int threadID) asm ("FLOPS_AVX");

// MUL added for Reirei
void IMUL_REG_REG(int threadID) asm ("IMUL_REG_REG");
